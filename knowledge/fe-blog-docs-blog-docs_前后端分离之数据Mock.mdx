...
以 json-server 作为 mock 服务器， mock.js 生成 mock 数据，利用 gulp + nodemon + browser-sync 监听mock文件的改动重启 node 服务，刷新浏览器，以此达到一种相对完美的 mock-server 要求
...
完整的代码详情 
https://github.com/poetries/mock-server
