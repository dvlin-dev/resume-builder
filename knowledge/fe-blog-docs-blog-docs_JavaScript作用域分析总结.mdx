...
1:找定义 var a function fn(){}

2:执行 a = 0; fn(); ===> 1:找定义 2:执行 alert(a); //undefined a = 1; alert(a); //1
...
2:执行 fn() ===> 1:找定义 function c 2:执行 alert(a); //undefined a = 3 return function c fn()() ==>1:找定义 function c 2:alert(a);//undefined 3 a = 0;
...
1:找定义 var a function fn var c

2:执行 a = 5; c = fn(); === > 1:找定义 var a function b 2:执行 a = 10; alert(a); //10 return function b(){}; c();=========> 1:找定义 2:执行 a++; //11 alert(a);//11 fn()(); //10 11 c() ========> 1:找定义 2:执行 a++;//11+1; alert(a); //12
