...
react-boilerplate-pro/src/layouts/BasicLayout.jsx
react-boilerplate-pro/src/layouts/NormalLayout.jsx
react-acl-router/src/AclRouter.jsx
...
但从理想的项目架构角度来讲这样做却是一个
反模式（anti-pattern）。因为应用页眉实际是一个应用级别的组件，但按照上述做法的话却变成了一个页面级别的组件，伪代码如下：
