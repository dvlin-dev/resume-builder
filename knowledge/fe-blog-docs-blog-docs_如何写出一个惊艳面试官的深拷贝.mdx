...
本文测试代码：
https://github.com/ConardLi/ConardLi.github.io/tree/master/demo/deepClone
...
下面，我们执行
clone4.test.js分别对上一个克隆函数和改写后的克隆函数进行测试：
