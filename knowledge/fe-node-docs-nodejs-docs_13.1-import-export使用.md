...
Node 9.x官方文档 
https://nodejs.org/dist/latest-v9.x/docs/api/esm.html
...
看看demo4，
https://github.com/chenshenhai/node-modules-demo/tree/master/demo4
...
注意： 目前Node对import/export的支持现在还是Stability: 1 - Experimental阶段，后续的发展还有很多不确定因素，自己练手玩玩还可以，但是在还没去flag使用之前，尽量不要在生产环境中使用。Node 9.x 更详细import/export的使用，可参考 
